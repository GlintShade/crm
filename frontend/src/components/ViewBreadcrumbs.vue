<template>
  <div class="flex items-center">
    ...
    >
      {{ routeName === 'Deals' ? __('Umowy') : routeName === 'Kalkulator' ? __('Kalkulator OZE') : routeName === 'KalkulatorCzystePowietrze' ? __('Kalkulator Czyste Powietrze') : routeName === 'DokumentyOze' ? __('Dokumenty OZE') : routeName === 'DokumentyCzystePowietrze' ? __('Dokumenty Czyste Powietrze') : routeName === 'MapaLeadow' ? __('Mapa leadów') : __(routeName) }}
    </router-link>
    <span
